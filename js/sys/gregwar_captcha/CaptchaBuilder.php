...
class CaptchaBuilder implements CaptchaBuilderInterface
{
    ...
    public function setMaxBehindLines($lines)
    {
        $this->maxBehindLines = $lines;

        return $this;
    }

    public function setMaxFrontLines($lines)
    {
        $this->maxFrontLines = $lines;
     ...
     * Instantiation
     */
    public static function create($phrase = null, $builder = null)
    {
        return new self($phrase, $builder);
    }
     ...
     */
    public function setBackgroundImages(array $imagepath1, $imagePath2)
    {
    ...
    protected function writePhrase($image, $phrase, $font, $width, $height)
    {
        ...
        $size = $width / $length - $this->rand(0, 3) - 9;
...
// echo $effects.':'.$this->maxBehindLines.':'.min($this->maxBehindLines, $effects);exit;
            ...
            if ($this->maxBehindLines !== 0) {
                for ($e = 0; $e < $this->maxBehindLines; $e++) {
